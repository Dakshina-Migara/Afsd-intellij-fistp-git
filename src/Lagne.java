...
public class Lagne {
    public static <Translate> void main(String[] args) {
        ...
        String dbEmail1 = scan.next();

        System.out.print("Enter the password: ");
        int dbPassword1 = scan.nextInt();

        if (dbEmail.equals(dbEmail1) && dbPassword == dbPassword1) {
                ...
                if (firstLetter1 % 2 == 0) {
                    ...
                    switch (lagnaya) {
                        ...
                        case "meena":
                            ...
                            lagnaya="මීන";
                            break;
                        default:prathipalaya="නිවැරදි ලග්නය ඇතුලත් කරන්න";
                    }
